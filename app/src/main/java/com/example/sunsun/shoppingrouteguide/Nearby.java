...
public class Nearby extends FragmentActivity implements OnMapReadyCallback,
    ...
    double latitude;
    double longitude;
    private int PROXIMITY_RADIUS1 = 2000;
    private int PROXIMITY_RADIUS2 = 2000;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Value="gas_station";
                    String url = getUrl1(latitude, longitude, Value);
                    Object[] DataTransfer = new Object[2];
                    DataTransfer[0] = mMap;
                    DataTransfer[1] = url;
                    Log.d("onClick", url);
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(Nearby.this,"Nearby Petrol pumps", Toast.LENGTH_LONG).show();
                ...
                else if (text.equals("Department store"))
                {
                    ...
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(Nearby.this,"Nearby Department Stores", Toast.LENGTH_LONG).show();
                }
                else if (text.equals("ATM"))
                {
                    ...
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(Nearby.this,"Nearby ATMs", Toast.LENGTH_LONG).show();
                }
